...
<!--================ Start Pricing Banner Area =================-->
        <section class="banner_area">
            ...
            <!-- <div class="banner_inner d-flex align-items-center" style="background-image: url(../admin/upload/banner/<?=$b->image;?>);width: 100%;height: 555px;"> -->
                <div class="banner_inner d-flex align-items-center" style="background-image: url(<?=base_url()?>assets/img/kontak_bg.png);width: 100%;height: 555px;">
                 <?php
                }
             ?>
                    ...
                    <div class="col-lg-12" >
                        <div class="contact_info">
                            <div class="info_item" style="padding-left: 0px;">
                                ...
                                <img src="<?=base_url()?>assets/img/kontak_alamat.png" style="width: 25px; height: 25px;">
                            ...
                            <div class="info_item" style="padding-left: 0px;">
                                ...
                                <img src="<?=base_url()?>assets/img/kontak_call.png" style="width: 25px; height: 25px;">
                            ...
                            <div class="info_item" style="padding-left: 0px;">
                                ...
                                <img src="<?=base_url()?>assets/img/kontak_mail.png" style="width: 25px; height: 25px;">
                                <h6 style="display: inline-flex;"><a href="mailto:<?=$website->email;?>"><?=$website->email?></a></h6>
                        ...
                        <form class="row justify-content-center contact_form" method="post" id="contact">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" id="inputMessage" rows="1" placeholder="Tulis pesan anda disini" required></textarea>
                                </div>
                            </div>
                             <div class="col-md-12 ">
                                <center>
                                <div id="recaptcha" class="g-recaptcha " data-sitekey="<?php echo $this->config->item('google_key') ?>" data-callback="enableBtnkontak"></div> 
                                </center>
                            </div>
                            <div class="col-md-12 text-center">
                                <button type="submit" value="submit" id="btn-validate-kontak" class="primary_btn" disabled="true" style="background-image: linear-gradient(to right, #0c3f84 , #021a3b);color: white"><span>Kirim Pesan</span></button>
                            </div>
                        </form>
