...
<?php foreach($this->db->query("SELECT * FROM tbl_banner where posisi='26' and tipe='1'")->result() as $b) { ?>
    <!-- <section class="home_banner_area" style="overflow-x:hidden; background: url('../admin/upload/banner/<?=$b->image;?>') no-repeat right center;background-size: cover;"> -->
        <section class="home_banner_area" style="overflow-x:hidden; background: url('<?=base_url()?>assets/img/Home_digi.png') no-repeat right center;background-size: cover;">
      <?php
  }
  ?>
...
<section class="home_gap" style="overflow-x:hidden ">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="text-center">Nikmati Layanan - Layanan</h2>
                <h2 class="text-center">Kami Berikan.</h2>
            </div>
        </div>
        <!-- .besar -->
        <div class="besar">
        <div class="recent_update_inner " >
            <ul class="nav nav-tabs justify-content-center product" id="myTab" role="tablist" >

               <li class="nav-item" style="max-width: 262px !important;">

                <a class="nav-link produk active " id="contact-tab" data-toggle="tab" href="#digitics" role="tab" aria-controls="digitics"
                aria-selected="false">
                <!-- <span class="lnr lnr-screen"></span> -->
                <!-- <img class="img-fluid" src="assets/ismg/produk/produk4.png" alt="" > -->
...
<div class="tab-content" id="myTab" style="margin-left: 100px;" >
    ...
    <div class="row recent_update_text align-items-center">
           ...
           <div class="col-lg-6 text-right">
            ...
            <div class="common_style">
                ...
                <p>Sebuah aplikasi yang dirancang khusus bagi para penyedia jasa layanan logistics, kurir, cargo dan tracking. Dengan ad anya aplikasi ProgiLOG memudahkan perusahaan logistics untuk memanagement barang-barang kiriman dari customer, baik outbound maupun inbound secara realtime.</p>
    ...
    <!-- .mv -->
        ...
        <div class="recent_update_inner " >
            <ul class="nav nav-tabs justify-content-center product" id="myTab" role="tablist" >
               ...
               <li class="nav-item" style="max-width: 85px !important;">

                <a class="nav-link produk active " id="contact-tab" data-toggle="tab" href="#digiticsm" role="tab" aria-controls="digitics"
                aria-selected="false">
                <!-- <span class="lnr lnr-screen"></span> -->
                <!-- <img class="img-fluid" src="assets/ismg/produk/produk4.png" alt="" > -->
                <div class="progilogm"></div>
                <!-- <h6 >ProgiLOG</h6> -->
            </a>
        ...
        <li class="nav-item" style="max-width: 85px !important;">
            <a class="nav-link produk" id="home-tab" data-toggle="tab" href="#homem" role="tab" aria-controls="home" aria-selected="true">
                <!-- <span class="lnr lnr-screen"></span> -->
                <!-- <img class="img-fluid" src="assets/img/produk/produk1.png" alt="" > -->
                <div class="progitrackm"></div>
                <!-- <h6 >ProgiTRACK</h6> -->
            </a>
        </li>

        <li class="nav-item" style="max-width: 85px !important;">
            <a class="nav-link produk" id="profile-tab" data-toggle="tab" href="#profilem" role="tab" aria-controls="profile"
            aria-selected="false">
            <!-- <span class="lnr lnr-screen"></span> -->
            <!-- <img class="img-fluid" src="assets/img/produk/produk2.png" alt="" > -->
            <div class="progicountingm"></div>
            <!-- <h6 >ProgiCOUNTING</h6> -->
        </a>
    </li>

    <li class="nav-item" style="max-width: 85px !important;">
        <a class="nav-link produk" id="contact-tab" data-toggle="tab" href="#contactm" role="tab" aria-controls="contact"
        aria-selected="false">
        <!-- <span class="lnr lnr-screen"></span> -->
        <!-- <img class="img-fluid" src="assets/img/produk/produk3.png" alt=""> -->
        <div class="progiposm"></div>
        <!-- <h6 >ProgiPOS</h6> -->
    </a>
</li>
...
<div class="tab-content" id="myTab" style="margin-left: 100px;" >
  <div class="tab-pane fadeIn isi active show" id="digiticsm" role="tabpanel" aria-labelledby="digitics-tab">
    <div class="row recent_update_text align-items-center">
    ...
    <div class="tab-pane fadeIn isi" id="homem" role="tabpanel" aria-labelledby="home-tab">
        <div class="row recent_update_text align-items-center">
    ...
    <div class="tab-pane fadeIn isi " id="profilem" role="tabpanel" aria-labelledby="contact-tab">
        <div class="row recent_update_text align-items-center">
        ...
        <div class="tab-pane fadeIn isi" id="contactm" role="tabpanel" aria-labelledby="contact-tab">
            <div class="row recent_update_text align-items-center">
...
<section class="big_features" style="overflow-x:hidden; background: url('<?=base_url()?>assets/img/profile_bg.png') no-repeat right center;background-size: cover;">
    <div class="container" >
        ...
        <div class="row features_content" data-aos="fade-left" data-aos-duration="800" hidden="">
            ...
            <div class="row features_content bottom-features" data-aos="fade-right" data-aos-duration="800">
                <div class="col-lg-12 text-center">
                   <h2 class="line">Apa Yang Kami Lakukan?</h2>
...
<div class="besar">
<section class="testimoni slider slider-image" data-aos="flip-up" data-aos-duration="800" style="overflow-x:hidden;height: auto !important;background: url('<?=base_url()?>assets/img/Maps_bg.png') no-repeat right center;background-size: cover;">
    ...
    <?php foreach($this->db->query("SELECT * FROM tbl_testimonial2 where status='Y'")->result() as $i) {  ?>  
        <div class="inner-slider">
            <a href="<?php echo base_url();?>testimoni/detail/testimoni<?php echo $i->id;?>">
                        <div class="col-md-10 col-sm-10 col-xs-10" style="margin-top: 42px;background-color: #fff;border-radius: 4%;background: #FFFFFF;box-shadow: 0px 4px 10px 5px rgba(0, 0, 0, 0.05)" data-aos="fade-right">
                          <div style="background-color:transparent; width: 100% !important; ">
                           <div class="row justify-content-center post-media wow fadeIn" style="position: relative;">
                            <!-- <center> -->
                              ...
                              top:-30px;">
                              <img src="https://www.digitalindo.co.id/upload/testimoni/<?php  echo $i->foto;?>" style="width: auto;height: 80px;margin: 0 auto;border-radius: 50%;border: 3px solid #fff;">
                              </div>
            ...
            <a class="slick-prev" id="sl2" href="#demo2" data-slide="prev" style="margin-left:-8%">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="slick-next" id="sl2" href="#demo2" data-slide="next" style="margin-left:87%">
...
<section style="margin-top: 200px;margin-bottom: 200px;" hidden="">
...
<!-- services start -->
            <section class="about-us-advantage-wrap section-padding" id="process" style="background: #0d438d;height: 200px;">
