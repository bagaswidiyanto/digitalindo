 <!--================ Start Element Banner Area =================-->
        <section class="banner_area">
            ...
            <!-- <div class="banner_inner d-flex align-items-center" style="background-image: url(../admin/upload/banner/<?=$b->image;?>);width: 100%;height: 555px;"> -->
                <div class="banner_inner d-flex align-items-center" style="background-image: url(<?=base_url()?>assets/img/karir_bg.png);width: 100%;height: 555px;">
                   <?php
                        }
                     ?>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12" style="float: left" data-aos="fade-right">
                  <div class="service-widget wow fadeIn" style="background-color:transparent; " data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="post-media wow fadeIn">
                            <a href="../admin/upload/career/<?=$p->image;?>" data-fancybox data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i>
                            <center><img src="../admin/upload/career/<?=$p->image;?>" alt="" style="width:190px ;height:140px;" class="img-fluid img-rounded"></center>
                            </a>
                        </div>

                         <h4>
                            <!-- <a href="<?php  echo base_url();?>karir/baca/<?php  echo $p->slug;?>"><?php  if (@$_GET['lang']=='eng'){ ?><?php  echo $p->name;?><?php  } else echo $p->name; ?></a> -->
                            <a href="../admin/upload/career/<?=$p->image;?>" data-fancybox><?php  echo $p->name;?></a></h4>
                      <p ><span class="fontsize13"><i class="fa fa-clock-o"></i>&nbsp;<?php  if (@$_GET['lang']=='eng'){ ?><?php  echo date('H:i, d M Y',strtotime($p->postDate));?><?php  } else echo date('H:i, d M Y',strtotime($p->postDate)); ?></p>

                        <p ><span class="fontsize13"><i class="fa fa-clock-o"></i>&nbsp;<?php  if (@$_GET['lang']=='eng'){ ?><?php  echo $p->kota;?><?php  } else echo $p->kota; ?></p>
                        <!-- <p >
