...
<!--================ Start Features Banner Area =================-->
    <section class="banner_area">
        ...
        <!-- <div class="banner_inner d-flex align-items-center" style="background-image: url(../../admin/upload/banner/<?=$b->image;?>);width: 100%;height: 555px;"> -->
             <div class="banner_inner d-flex align-items-center" style="background-image: url(<?=base_url()?>assets/img/fitur_bg.png);width: 100%;height: 555px;">
              <?php
                }
             ?>
               ...
               <?php foreach($this->db->query("SELECT * FROM tbl_fitur order by sort")->result() as $fitur) { 
                ...
                <section id="<?=$fitur->slug?>">
                    ...
                    <div class="text-center" data-aos="flip-up">
                        <div><h2 style="text-align: center;"><b style="text-align: center;color: black;"><?=$fitur->nama?></b></h2></div>
                    </div>
                        <div class="blog wow animated animated2 " style="text-align:justify" data-aos="fade-up" data-aos-duration="2000">
                        
                        <center>
                        <a href="https://digitalindo.co.id/admin/upload/fitur/<?=$fitur->image;?>" data-fancybox="gallery"><img src="https://digitalindo.co.id/admin/upload/fitur/<?=$fitur->image?>" ></a>
                        </center><br><br><br>
                        <?=$fitur->content?>
