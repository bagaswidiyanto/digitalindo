...
<div id="mylogin" class="modal fade" role="dialog">
  <div class="modal-dialog" style="width: 40%;margin-top: 8%;max-width: 100%">
  ...
  $.ajax({
      ...
      success: function(data){
          ...
          if(data.indexOf("Maaf ada yang sedang menggunakan akun ini atau tunggu 10 menit") > -1){
            ...
            setInterval(function(){ window.location='https://mytask.digitalindo.co.id/inc/login.php?t='+data; }, 1000);
          } 
